...
<body>
    <main>
        ...
        <section class="home_work">
            <p>
                Для закрепления в отдельном файле под названием home work будем делать самостоятельную работу.<br>
                Создаем страницу player.php и БД music, где name-название композиций, author-исполнитель.<br>
                На странице player.php создаем базовую разметку HTML и выводим на ней все данные из нашей таблицы music.<br>
                Далее создаем форму с полями author и name с кнопкой ДОБАВИТЬ и пишем код так, чтобы можно было через данную форму добавлять данные в наше таблицу music.
            </p>
        </section>
    </main>
